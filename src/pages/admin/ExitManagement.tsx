...
const ExitManagement: React.FC = () => {
  ...
  return (
    <div>
      <h2 style={{ marginBottom: 20, fontSize: 20, fontWeight: 600 }}>退出管理</h2>
        ...
        {currentRecord && (
          <>
            <Descriptions bordered column={2} size="small" style={{ marginBottom: 24 }}>
              ...
              <Descriptions.Item label="退出原因">{currentRecord.reason}</Descriptions.Item>
